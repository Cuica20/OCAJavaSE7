...
public class ModuloOperator {
	...
	public static void main(String[] args) {
		...
		// Example 2 - module operator on 10 can give you last digit of integer
		// number
		int number = 215;
		int total = 349;
		...
		// Example 3 - You can use modulo operator on 2 to check if number is
		// even or odd
		int even = 22;
        int odd = 21;
	...
	public static String oddness(final int i) {
